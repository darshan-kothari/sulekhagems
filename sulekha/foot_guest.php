...
setInterval("displayit()",slidedelay)
   ...
   <div id="footer">
	<div id="youtube"><img src="image/images.png" border="0" usemap="#Map2" />
<map name="Map2" id="Map2">
  ...
  <area shape="rect" coords="93,0,151,29" href="#" /><area shape="rect" coords="43,0,92,25" href="#" /><area shape="rect" coords="1,2,46,25" href="#" /></map></div>
	<div id="menu_footer">
	<div style="width:500px;font-size:12px;font-family:Arial, Helvetica, sans-serif;padding-top:2px;"><a href="../index.html">Home</a> | <a href="about.php">About Us</a> |  <a href="#">Privacy Policy</a> | <a href="#">Support</a><br/>
	</div>
	<div style="text-align:center;width:500px;font-weight:bold;font-size:12px;font-family:Arial, Helvetica, sans-serif;">Copyright 2011@<a href="www.vardhamaninfotech.com"> Vardhaman Infotech</a> all Rights Reserved</div>
	</div>
  </div>
</div>  
