...
while($row=mysql_fetch_array($result))
	...
	echo "<td width=20% valign=top class=td_show_jems><table><tr><td><a href=cart.php?p_id=".$row["p_id"]."&p_name=".$row["p_name"]."&p_price=".$row["p_price"]."&location=reg_semi_jems.php><img src=precious_images/shop2.png width=50px height=50px border=0></td></tr>
	<tr><td>
