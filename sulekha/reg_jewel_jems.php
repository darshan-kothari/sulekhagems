...
$category="Jewellery";
$data=mysql_query("SELECT count(*) AS total FROM product where p_category='Jewellery'");
...
$result=mysql_query("select * from product where p_category='Jewellery' ORDER BY p_id DESC limit $offset, $rowsPerPage ");
...
while($row=mysql_fetch_array($result))
	...
	echo "<td width=20% valign=top class=td_show_jems><table><tr><td><a href=cart.php?p_id=".$row["p_id"]."&p_name=".$row["p_name"]."&p_price=".$row["p_price"]."&location=reg_jewel_jems.php><img src=precious_images/shop2.png width=50px height=50px border=0></td></tr>
	<tr><td>
...
$query   = "SELECT COUNT(p_id) AS numrows FROM product where p_category='Jewellery'"; 
